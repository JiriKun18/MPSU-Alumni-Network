...
<head>
    ...
    <script>
        window.APP_API_BASE = "<?php echo e(rtrim(url('/'), '/')); ?>";
    </script>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('images/logo_mpsu.png')); ?>">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav ms-auto d-flex align-items-center">
                    <?php if(Auth::check()): ?>
                        <a href="<?php echo e(route('jobs.index')); ?>" class="nav-link"><i class="fas fa-briefcase"></i> Jobs</a>
                        <a href="<?php echo e(route('events.index')); ?>" class="nav-link"><i class="fas fa-calendar"></i> Events</a>
                        <a href="<?php echo e(route('news.index')); ?>" class="nav-link"><i class="fas fa-newspaper"></i> News</a>
                        <?php if(Auth::user()->role === 'alumni'): ?>
                            <a href="<?php echo e(route('alumni.directory')); ?>" class="nav-link"><i class="fas fa-users"></i> Alumni</a>
                            <a href="<?php echo e(route('surveys.index')); ?>" class="nav-link"><i class="fas fa-poll"></i> Surveys</a>
                        <?php endif; ?>
                        ...
                        <div class="dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" style="background: rgba(212, 175, 55, 0.25); border-radius: 6px; padding: 0.4rem 0.8rem !important;">
                                ...
                                ?>
                                <i class="fas fa-user-circle"></i> <?php echo e($navDisplayName ?: Auth::user()->name); ?>

                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <?php if(Auth::user()->role === 'alumni'): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('alumni.dashboard')); ?>"><i class="fas fa-home"></i> Dashboard</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('alumni.profile')); ?>"><i class="fas fa-user"></i> My Profile</a></li>
                                <?php endif; ?>
                                <?php if(Auth::user()->role === 'admin'): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-crown"></i> Admin Dashboard</a></li>
                                <?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('home')); ?>#features" class="nav-link"><i class="fas fa-star"></i> Features</a>
                        <a href="<?php echo e(route('home')); ?>#how-it-works" class="nav-link"><i class="fas fa-info-circle"></i> How It Works</a>
                        <div class="navbar-divider"></div>
                        <a href="<?php echo e(route('login')); ?>" class="nav-link" style="background: rgba(212, 175, 55, 0.25); border-radius: 6px; padding: 0.4rem 0.8rem !important;">
...
<?php /**PATH C:\laragon\www\alumni system\resources\views/layout.blade.php ENDPATH**/ ?>