...
<?php $__env->startSection('title', 'Alumni Directory - MPSU Alumni Network'); ?>
...
<div class="container-fluid py-5">
    ...
    <?php if(Auth::user() && !Auth::user()->is_verified): ?>
    ...
    <div class="card mb-4" style="border-radius: 12px; border: 1px solid #e2e8f0;">
        <div class="card-body">
            <form class="row g-3" method="GET" action="<?php echo e(route('alumni.alumni-dir')); ?>" id="filterForm">
                <div class="col-md-6">
                    ...
                    <select name="batch" class="form-select" style="border-radius: 8px;">
                        ...
                        <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($batch->id); ?>" <?php echo e(request('batch') == $batch->id ? 'selected' : ''); ?>>
                                Batch <?php echo e($batch->year); ?>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0;">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $alumni; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alumni_profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="border-bottom: 1px solid #e2e8f0; transition: background 0.2s;">
                                    <!-- Photo -->
                                    <td style="padding: 1rem; vertical-align: middle;">
                                        <?php if($alumni_profile->profile_picture): ?>
                                            <img src="<?php echo e(asset('storage/' . $alumni_profile->profile_picture)); ?>" 
                                                 alt="<?php echo e($alumni_profile->family_name); ?>" 
                                        ...
                                        <?php else: ?>
                                            <div style="width: 50px; height: 50px; border-radius: 8px; background: linear-gradient(135deg, #1a472a 0%, #2d5016 100%); border: 2px solid #d4af37; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700;">
                                                <?php echo e(substr($alumni_profile->given_name ?? $alumni_profile->family_name ?? $alumni_profile->user->name ?? 'A', 0, 1)); ?>
                                    ...
                                    <td style="padding: 1rem; vertical-align: middle;">
                                        <div style="font-weight: 600; color: var(--primary-color); font-size: 1rem;">
                                            ...
                                            ?>
                                            <?php echo e($fullName ?: $alumni_profile->user->name ?? 'Not available'); ?>
                                    ...
                                    <td style="padding: 1rem; vertical-align: middle;">
                                        <div style="font-size: 0.9rem;">
                                            <?php if($alumni_profile->course): ?>
                                                <strong><?php echo e($alumni_profile->course); ?></strong>
                                            <?php endif; ?>
                                            <?php if($alumni_profile->batch_id): ?>
                                                <br><small class="text-muted">Batch <?php echo e($alumni_profile->batch->year ?? 'N/A'); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                    ...
                    <div class="p-3 border-top">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted">
                                Showing <?php echo e($alumni->firstItem()); ?> to <?php echo e($alumni->lastItem()); ?> of <?php echo e($alumni->total()); ?> alumni
                            </div>
                            <div>
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="card shadow-sm mb-4 w-100" style="border-radius: 16px; border-left: 6px solid var(--accent-gold);">
                <div class="card-body">
                    ...
                    <?php if($alumniSpotlight->featured_image): ?>
                        <img src="<?php echo e(asset('storage/' . $alumniSpotlight->featured_image)); ?>" alt="<?php echo e($alumniSpotlight->title); ?>" style="width: 100%; height: 200px; object-fit: cover; border-radius: 12px; display: block; margin-bottom: 0.75rem;">
                    <?php endif; ?>
                    <h5 class="mb-2" style="font-weight: 700; color: var(--secondary-color);"><?php echo e($alumniSpotlight->title); ?></h5>
                    <p class="card-text text-muted" style="font-size: 1rem;">
                        <?php echo e(\Illuminate\Support\Str::limit(strip_tags($alumniSpotlight->content), 180)); ?>

                    </p>
                    <div class="mt-3 text-end">
                        <a href="<?php echo e(route('news.show', $alumniSpotlight->id)); ?>" class="btn btn-outline-primary w-100" style="font-weight: 600;">
...
<?php echo $__env->make('layouts.alumni', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\alumni system\resources\views/alumni/directory.blade.php ENDPATH**/ ?>