...
<?php $__env->startSection('title', 'Sign Up - MPSU Alumni Network'); ?>
            ...
            <div class="card shadow-lg border-0" style="border-top: 4px solid var(--accent-gold);">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <img src="<?php echo e(asset('images/logo_mpsu.png')); ?>" alt="MPSU Logo" style="max-width: 80px; margin-bottom: 15px;">
                    ...
                    <form action="<?php echo e(route('signup.step1.submit')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control form-control-lg <?php $__errorArgs = ['family_name'];
...
unset($__errorArgs, $__bag); ?>" id="family_name" name="family_name" placeholder="Enter family name" value="<?php echo e(old('family_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control form-control-lg <?php $__errorArgs = ['given_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="given_name" name="given_name" placeholder="Enter given name" value="<?php echo e(old('given_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-2 mb-2">
                                <label for="middle_initial" class="form-label fw-bold">MI</label>
                                 <input type="text" class="form-control form-control-lg <?php $__errorArgs = ['middle_initial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="middle_initial" name="middle_initial" placeholder="M" value="<?php echo e(old('middle_initial')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-2 mb-2">
                                ...
                                <input type="text" class="form-control form-control-lg <?php $__errorArgs = ['suffix'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="suffix" name="suffix" placeholder="Jr, Sr, III" value="<?php echo e(old('suffix')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mb-2">
                                ...
                                <select class="form-select form-select-lg <?php $__errorArgs = ['sex'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="date" class="form-control form-control-lg <?php $__errorArgs = ['date_of_birth'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control form-control-lg <?php $__errorArgs = ['contact_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <div class="address-selector-section">
                            ...
                            <div class="address-hierarchy-row">
                                <div class="address-field-group">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['present_country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            data-selected="<?php echo e(old('present_country') ?? ''); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="address-hierarchy-row">
                                <div class="address-field-group">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['present_region'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            data-selected="<?php echo e(old('present_region') ?? ''); ?>" disabled required>
                                        <option value="">Select Region</option>
                                    </select>
                                    <?php $__errorArgs = ['present_region'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="address-hierarchy-row">
                                <div class="address-field-group">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['present_province'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            data-selected="<?php echo e(old('present_province') ?? ''); ?>" disabled required>
                                        <option value="">Select Province</option>
                                    </select>
                                    <?php $__errorArgs = ['present_province'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="address-hierarchy-row">
                                <div class="address-field-group">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['present_city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            data-selected="<?php echo e(old('present_city') ?? ''); ?>" disabled required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="address-hierarchy-row">
                                <div class="address-field-group">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['present_barangay'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            data-selected="<?php echo e(old('present_barangay') ?? ''); ?>" disabled required>
                                        <option value="">Select Barangay</option>
                                    </select>
                                    <?php $__errorArgs = ['present_barangay'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control form-control-lg <?php $__errorArgs = ['campus'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="Bontoc Campus" <?php echo e(old('campus') == 'Bontoc Campus' ? 'selected' : ''); ?>>Bontoc Campus</option>
                                <option value="Tadian Campus" <?php echo e(old('campus') == 'Tadian Campus' ? 'selected' : ''); ?>>Tadian Campus</option>
                                <option value="Paracelis Campus" <?php echo e(old('campus') == 'Paracelis Campus' ? 'selected' : ''); ?>>Paracelis Campus</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control form-control-lg <?php $__errorArgs = ['course_graduated'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <?php $__errorArgs = ['course_graduated'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control form-control-lg <?php $__errorArgs = ['year_graduated'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('year_graduated')); ?>" min="1950" max="<?php echo e(date('Y')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control form-control-lg <?php $__errorArgs = ['profile_picture'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <div class="card" style="border: 2px dashed #17a2b8; border-radius: 16px; background: linear-gradient(135deg, rgba(23, 162, 184, 0.05) 0%, rgba(23, 162, 184, 0.02) 100%);">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control <?php $__errorArgs = ['verification_documents'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__errorArgs = ['verification_documents'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="terms_accepted" name="terms_accepted" value="1" <?php echo e(old('terms_accepted') ? 'checked' : ''); ?> required>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php echo $__env->make('legal.partials.terms-of-service-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="privacyModal" tabindex="-1" aria-labelledby="privacyModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-muted mb-4">Last Updated: January 23, 2026</p>
                    <?php echo $__env->make('legal.partials.privacy-policy-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    campusSelect.addEventListener('change', function() {
        ...
        fetch(`${globalApiBase}/courses?campus=${encodeURIComponent(selectedCampus)}`)
            ...
            .then(data => {
                ...
                const oldValue = "<?php echo e(old('course_graduated')); ?>";
                if (oldValue) {
    ...
    window.addEventListener('DOMContentLoaded', function() {
        const oldCampus = "<?php echo e(old('campus')); ?>";
        if (oldCampus) {
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\alumni system\resources\views/auth/signup/step1.blade.php ENDPATH**/ ?>