...
@section('title', 'Alumni Dashboard - MPSU Alumni Network')
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                @endphp
                <h1 style="font-size: 2.5rem; font-weight: 900; margin-bottom: 1rem;">Welcome Back, {{ $displayFullName ?: Auth::user()->name }}! 👋</h1>
                ...
                <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
                    <a href="{{ route('alumni.profile.edit') }}" style="background: var(--accent-gold); color: var(--primary-color); padding: 0.85rem 2rem; border-radius: 8px; text-decoration: none; font-weight: 700; font-size: 1rem; transition: all 0.3s ease; display: inline-block;">
                        <i class="fas fa-user-edit"></i> Update Your Profile
                    </a>
                </div>
            </div>
            <div class="col-lg-4 text-center d-none d-lg-block">
                @if(Auth::user()->alumniProfile && Auth::user()->alumniProfile->profile_picture)
                    <img src="{{ asset('storage/' . Auth::user()->alumniProfile->profile_picture) }}" 
                         alt="{{ Auth::user()->name }}" 
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-md-4 col-sm-6">
                <a href="{{ route('alumni.alumni-dir') }}" style="text-decoration: none;">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="{{ route('surveys.index') }}" style="text-decoration: none;">
                    <div style="background: white; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.08); transition: all 0.3s ease; border: 2px solid transparent;">
                        <div style="font-size: 3rem; color: var(--accent-gold); margin-bottom: 1rem;">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="{{ route('alumni.profile') }}" style="text-decoration: none;">
                    <div style="background: white; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.08); transition: all 0.3s ease; border: 2px solid transparent;">
                        <div style="font-size: 3rem; color: var(--accent-gold); margin-bottom: 1rem;">
        ...
        <div class="row g-4">
            <div class="col-lg-6">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                    ...
                    <a href="{{ route('events.index') }}" style="color: var(--accent-gold); font-weight: 600; text-decoration: none;">View All Events →</a>
                </div>
                    ...
                    <div class="col-12">
                        <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column; border-top: 4px solid var(--accent-gold);">
                            ...
                            <div style="padding: 1.5rem; flex: 1; display: flex; flex-direction: column;">
                                ...
                                <h5 style="font-weight: 700; color: var(--primary-color); margin-bottom: 0.75rem; margin-top: 0.5rem;">{{ $event->title }}</h5>
                                @if($event->venue)
                                ...
                                <a href="{{ route('events.show', $event->id) }}" style="display: inline-block; background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); color: white; padding: 0.6rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 0.9rem; align-self: flex-start;">Read More</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="col-lg-6">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                    ...
                    <a href="{{ route('news.index') }}" style="color: var(--accent-gold); font-weight: 600; text-decoration: none;">View All News →</a>
                </div>
                    ...
                    <div class="col-12">
                        <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08); transition: all 0.3s ease; height: 100%; display: flex; flex-direction: column;">
                            ...
                            <div style="padding: 1.5rem; flex: 1; display: flex; flex-direction: column;">
                                ...
                                <h5 style="font-weight: 700; color: var(--primary-color); margin-bottom: 0.75rem; margin-top: 0.5rem;">{{ $news->title }}</h5>
                                <p style="color: #64748b; font-size: 0.9rem; margin-bottom: 1rem; flex: 1;">
                                    {{ \Illuminate\Support\Str::limit(strip_tags($news->content), 100) }}
                                </p>
                                <a href="{{ route('news.show', $news->id) }}" style="display: inline-block; background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); color: white; padding: 0.6rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 0.9rem; align-self: flex-start;">Read More</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
<section style="background: white; padding: 3rem 0;">
    <div class="container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            ...
            <a href="{{ route('jobs.index') }}" style="color: var(--accent-gold); font-weight: 600; text-decoration: none;">View All Jobs →</a>
        </div>
                ...
                <div style="background: white; border-radius: 12px; padding: 1.5rem; box-shadow: 0 4px 15px rgba(0,0,0,0.08); border-top: 4px solid var(--accent-gold); height: 100%;">
                    <div class="row g-3 align-items-stretch">
                        <div class="col-12 col-md-7">
                            <h5 style="font-weight: 700; color: var(--primary-color); margin-bottom: 0.75rem;">{{ $job->title }}</h5>
                            ...
                            <a href="{{ route('jobs.show', $job->id) }}" style="display: inline-block; background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); color: white; padding: 0.6rem 1.5rem; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 0.9rem;">View Details</a>
                        </div>
                        <div class="col-12 col-md-5">
                            @php
                                $mapQuery = trim($job->contact_address ?: ($job->location ?: $job->company_name));
                            @endphp
                            <div class="job-map-canvas" data-lat="{{ $job->latitude }}" data-lng="{{ $job->longitude }}" data-map="{{ $mapQuery }}"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4">
            <div class="col-md-3 col-sm-6">
                <div style="background: white; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.08); border-top: 4px solid var(--primary-color);">
                    ...
                    <h3 style="font-size: 2rem; font-weight: 800; color: var(--primary-color); margin-bottom: 0.5rem;">{{ $profile ? '✓' : '✗' }}</h3>
                    <p style="color: #64748b; font-weight: 600; margin: 0;">Profile Status</p>
                    <small style="color: #94a3b8;">{{ $profile ? 'Complete' : 'Incomplete' }}</small>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div style="background: white; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.08); border-top: 4px solid var(--secondary-color);">
                    ...
                    <h3 style="font-size: 2rem; font-weight: 800; color: var(--primary-color); margin-bottom: 0.5rem;">{{ Auth::user()->jobApplications()->count() }}</h3>
            ...
            <div class="col-md-3 col-sm-6">
                <div style="background: white; border-radius: 12px; padding: 2rem; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.08); border-top: 4px solid var(--accent-gold);">
                    ...
                    <h3 style="font-size: 2rem; font-weight: 800; color: var(--primary-color); margin-bottom: 0.5rem;">{{ Auth::user()->eventRegistrations()->count() }}</h3>
