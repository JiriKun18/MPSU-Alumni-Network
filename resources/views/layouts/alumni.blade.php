...
<body>
    ...
    <div class="navbar-secondary">
        ...
        <a href="{{ route('alumni.about') }}#features" class="scroll-to-section"><i class="fas fa-star"></i> Features</a>
        <a href="{{ route('alumni.about') }}#how-it-works" class="scroll-to-section"><i class="fas fa-info-circle"></i> How It Works</a>
    </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav navbar-nav-premium">
                    <li class="nav-item nav-item-premium">
                        <a class="nav-link nav-link-premium {{ Request::is('alumni/dashboard') ? 'active' : '' }}" href="{{ route('alumni.dashboard') }}">
                            <i class="fas fa-home"></i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li class="nav-item nav-item-premium">
                        <a class="nav-link nav-link-premium {{ Request::is('jobs*') ? 'active' : '' }}" href="{{ route('jobs.index') }}">
                            <i class="fas fa-briefcase"></i>
                            <span>Jobs</span>
                        </a>
                    </li>
                    <li class="nav-item nav-item-premium">
                        <a class="nav-link nav-link-premium {{ Request::is('events*') ? 'active' : '' }}" href="{{ route('events.index') }}">
                            <i class="fas fa-calendar-alt"></i>
                            <span>Events</span>
                        </a>
                    </li>
                    <li class="nav-item nav-item-premium">
                        <a class="nav-link nav-link-premium {{ Request::is('news*') ? 'active' : '' }}" href="{{ route('news.index') }}">
                            <i class="fas fa-newspaper"></i>
                            <span>News</span>
                        </a>
                    </li>
                    <li class="nav-item nav-item-premium">
                        <a class="nav-link nav-link-premium {{ Request::is('alumni/directory*') ? 'active' : '' }}" href="{{ route('alumni.alumni-dir') }}">
                            <i class="fas fa-users"></i>
                            <span>Alumni</span>
                        </a>
                    </li>
                    <li class="nav-item nav-item-premium">
                        <a class="nav-link nav-link-premium {{ Request::is('surveys*') ? 'active' : '' }}" href="{{ route('surveys.index') }}">
                ...
                <ul class="navbar-nav navbar-nav-premium ms-auto">
                    <li class="nav-item nav-item-premium dropdown">
                        ...
                        <a class="nav-link nav-link-premium user-dropdown-toggle dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                            ...
                            <span class="user-name d-none d-lg-inline">{{ Auth::user() ? Auth::user()->name : 'Guest' }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-premium dropdown-menu-end" aria-labelledby="userDropdown">
                            <li>
                                <a class="dropdown-item dropdown-item-premium" href="{{ route('alumni.profile') }}">
                        ...
                        @else
                        <a class="nav-link nav-link-premium" href="{{ route('login') }}" style="background: rgba(212, 175, 55, 0.25); border-radius: 6px; padding: 0.4rem 0.8rem !important;">
        ...
        <div class="container">
            <div class="row" style="text-align: left; padding: 2rem 0;">
                <div class="col-md-4 mb-4">
                    <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 1rem;">
                        <img src="{{ asset('images/logo_mpsu.png') }}" alt="MPSU Logo" style="height: 40px; width: 40px; border-radius: 8px;">
            ...
            <div style="border-top: 1px solid rgba(255,255,255,0.2); padding-top: 1.5rem; text-align: center;">
                <div style="margin-bottom: 1rem;">
                    <a href="{{ route('privacy-policy') }}" style="color: rgba(255,255,255,0.9); text-decoration: none; margin: 0 1rem; font-size: 0.9rem;">Privacy Policy</a>
                    <span style="color: rgba(255,255,255,0.5);">|</span>
                    <a href="{{ route('terms-of-service') }}" style="color: rgba(255,255,255,0.9); text-decoration: none; margin: 0 1rem; font-size: 0.9rem;">Terms of Service</a>
                </div>
