        ...
        * {
        ...
        .hero-section {
            background: linear-gradient(135deg, rgba(13, 77, 45, 0.85) 0%, rgba(26, 107, 61, 0.85) 100%), 
                        url('{{ asset('images/logo_mpsu.png') }}') center/cover;
            color: white;
            padding: 6rem 0;
            text-align: center;
            position: relative;
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <div class="navbar-nav ms-auto d-flex align-items-center">
                    ...
                    <a href="{{ route('login') }}" class="navbar-link-premium" style="background: rgba(212, 175, 55, 0.25); border-radius: 6px; padding: 0.4rem 0.8rem !important;">
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    <a href="{{ route('signup.step1') }}" class="btn-premium btn-premium-primary">
                        <i class="fas fa-user-plus"></i> Join the Network
                    </a>
                    <a href="{{ route('login') }}" class="btn-premium btn-premium-secondary">
                ...
                <div class="hero-stats">
                    <div class="hero-stat">
                        <div class="hero-stat-number">{{ number_format($registeredUsers) }}</div>
                        <div class="hero-stat-label">Alumni Connected</div>
                    </div>
                    <div class="hero-stat">
                        <div class="hero-stat-number">{{ number_format($jobsOffered) }}</div>
                        <div class="hero-stat-label">Jobs Offered</div>
                    </div>
                    <div class="hero-stat">
                        <div class="hero-stat-number">{{ $yearsLegacy }}</div>
                ...
                <div class="row" style="text-align: center;">
                    <div class="col-md-3 col-6 mb-3 mb-md-0">
                        <div style="color: var(--accent-gold); font-weight: 700; font-size: 1.5rem; margin-bottom: 0.5rem;">
                            <i class="fas fa-users"></i> {{ number_format($registeredUsers) }}
                        </div>
                        <div style="font-size: 0.85rem; opacity: 0.9;">Active Alumni Members</div>
                    </div>
                    <div class="col-md-3 col-6 mb-3 mb-md-0">
                        <div style="color: var(--accent-gold); font-weight: 700; font-size: 1.5rem; margin-bottom: 0.5rem;">
                            <i class="fas fa-briefcase"></i> {{ number_format($jobsOffered) }}
                        </div>
                        <div style="font-size: 0.85rem; opacity: 0.9;">Jobs Offered</div>
                    </div>
                    <div class="col-md-3 col-6 mb-3 mb-md-0">
                        <div style="color: var(--accent-gold); font-weight: 700; font-size: 1.5rem; margin-bottom: 0.5rem;">
                            <i class="fas fa-calendar"></i> {{ number_format($totalEvents) }}
                        </div>
                        <div style="font-size: 0.85rem; opacity: 0.9;">Annual Events</div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div style="color: var(--accent-gold); font-weight: 700; font-size: 1.5rem; margin-bottom: 0.5rem;">
                            <i class="fas fa-graduation-cap"></i> {{ $yearsLegacy }}
                        </div>
